...
| [Enable in-app update checker](#enable-in-app-update-checker) | Checks for newer patched Google Photos releases on GitHub and prompts to update. | • GitHub Release API URL |
